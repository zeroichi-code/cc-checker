...
**① リポジトリページ右上の緑の「Code」ボタンをクリック**

![GitHub Code ボタン](docs/github-download.png)

**② 「Download ZIP」をクリック**

![Download ZIP](docs/github-code-dropdown.png)

**③ ダウンロードした ZIP を解凍して、フォルダ内の `起動する.bat` をダブルクリック**
